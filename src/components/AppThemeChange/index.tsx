  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={() => changeTheme(EAppTheme.SYSTEM)}>System</DropdownMenuItem>

        <DropdownMenuItem onClick={() => changeTheme(EAppTheme.LIGHT)}>Light</DropdownMenuItem>

        <DropdownMenuItem onClick={() => changeTheme(EAppTheme.DARK)}>Dark</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
});
